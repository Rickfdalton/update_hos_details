...
const delFacs = document.querySelectorAll(".del");
...
facilities.forEach(function (facilityBox) {
  facilityBox.addEventListener("click", function () {
    ...
    document.getElementById("fac").value =
      facilityBox.querySelector(".facility-heading").textContent;
    document.getElementById("start-time").value = facilityBox
      .querySelector(".start-time")
      .querySelector(".time").textContent;
    document.getElementById("end-time").value = facilityBox
...
delFacs.forEach(function (delFac) {
